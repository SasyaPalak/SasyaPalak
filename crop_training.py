...
new_sample = {
    'Region': 1,  # Example: Region=1
    'Season': 0,  # Example: Season=0
    'Crop': 2,    # Example: Crop=2
    'Area': 500   # Example: Area=500 hectares
}

predicted_yield, yield_status = predict_crop_yield(new_sample)
print(f"Predicted Crop Yield: {predicted_yield} tons")
print(f"Crop Yield Status: The predicted yield is {yield_status}.")
